...
Try {
    ...
    $null = . {
        ...
        Add-Tracelog -Message "Executing Control Runbook: Template-Control-Fail"
        $Output = .\Template-Control-Fail.ps1 -ResourceGroupName $ResourceGroupName -OtherParameter $OtherParameter
